    ...
    public class BattleClass
    {
        ...
        public void RaidIn() //바칼레이드 전투 로직
        {
            ...
            while (AN.bakalPhase == 2)
            {
                ...
                if (AN.bakalphase2Atk < 97) //if(AN.bakalphase2Atk < 97)  //test if(AN.bakalphase2Atk < 50)
                { 
                //바칼이 공격할턴
                Console.Clear();
                BakalDragon();
                ...
                if (AN.bakalphase2Atk >= 98) //바칼 필살기  //if(AN.bakalphase2Atk >= 98)  //test  if(AN.bakalphase2Atk >= 50)
                {
                    Console.Clear();
                    CS.BakalPhase2Skill();
                    Console.Clear();
